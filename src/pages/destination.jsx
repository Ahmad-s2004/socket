    ...
    return (
        <div className="min-h-screen bg-slate-50 text-slate-800 font-sans antialiased overflow-x-hidden selection:bg-blue-600 selection:text-white">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24 relative z-10">
                <div className="bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-950 text-white rounded-3xl p-6 md:p-12 relative overflow-hidden flex flex-col lg:flex-row lg:items-center justify-between gap-8 shadow-xl">
                    ...
                    {/* Form Container: Width controls optimized for mobile vs desktop */}
                    <div className="relative z-10 w-full lg:w-auto max-w-md lg:min-w-[380px]">
                        <form
                            className="flex flex-col sm:flex-row gap-2 p-1.5 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-md w-full"
                            onSubmit={(e) => e.preventDefault()}
                        >
                            <input
                                type="email"
                                required
                                placeholder="Enter custom email node"
                                className="bg-transparent text-xs px-4 py-3 outline-none flex-1 min-w-0 text-white placeholder-slate-500 font-semibold rounded-xl"
                            />
                            <button
                                type="submit"
                                className="bg-white hover:bg-slate-100 text-slate-900 font-black text-xs px-5 py-3 rounded-xl transition whitespace-nowrap uppercase tracking-wider w-full sm:w-auto"
                            >
                                Notify Registry
                            </button>
                        </form>
